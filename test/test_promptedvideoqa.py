...
class VideoVQAGenerator():
    def __init__(self):
        self.storage = FileStorage(
            first_entry_file_name="/mnt/shared-storage-user/mineru2-shared/niujunbo/DataFlow-MM/dataflow/example/video/sample_data.json",
            cache_path="./cache",
        ...
        self.vlm_serving = LocalModelVLMServing_vllm(
            ...
            hf_model_name_or_path="/mnt/shared-storage-user/mineru2-shared/niujunbo/model/Qwen/Qwen2.5-VL-7B-Instruct",
